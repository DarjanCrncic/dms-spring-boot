...
class DocumentControllerTest {
	...
	void setUp() {
		...
		modifyDocumentDTO = ModifyDocumentDTO.builder().objectName("modifiedDoc").description("this is the modified doc")
				.keywords(Arrays.asList(new String[] { "prvi", "drugi" })).typeName("tajni").build();
	}
	...
	void modifyDocumentPutTest() throws Exception {
		BDDMockito.given(documentService.updateDocument(Mockito.any(UUID.class), Mockito.any(ModifyDocumentDTO.class), Mockito.anyBoolean())).willReturn(validDocumentDTO);
